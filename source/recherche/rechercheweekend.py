...
class RechercheWeekend(AbstractRecherche):
    ...
    def recherche(date, origine, destination, alerter = False, eligible = "OUI"):
        
        DAOHistorique.remplir("weekend", date=date,origine=origine,destination=destination,alerter=alerter, eligible=eligible )
        ...
        DAOTrajet.DAOTrajet(url_aller)
        DAOTrajet.DAOTrajet(url_retour)
